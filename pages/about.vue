<template>
    <div class="relative">
        ...
        <div class="container mx-auto px-10">
            <div class="lg:flex">
                <div class="lg:w-1/2 lg:pr-4">
                    ...
                    <div>
                        <div class="font-medium mb-2 mt-6 text-4xl">The Nubia Way</div>
                        <div class="p-2"></div>
                ...
                <div class="lg:w-1/2 lg:pl-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="shadow-lg bg-gray-50 p-4 text-center">
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-6 mx-auto text-center">
                <div class="shadow-md p-4">
                    ...
                    <div class="font-medium text-base">Growth capital</div>
                </div>
                ...
                <div class="shadow-md p-4">
                    ...
                    <div class="font-medium text-base">Majority recapitalization</div>
                </div>
                ...
                <div class="shadow-md p-4">
                    ...
                    <div class="font-medium text-base">100% buyout</div>
                </div>
                ...
                <div class="shadow-md p-4">
                    ...
                    <div class="font-medium text-base">Corporate carve-outs and businesses undergoing transitions</div>
                </div>
                ...
                <div class="shadow-md p-4">
                    ...
                    <div class="font-medium text-base">Check size: Min - $5 million | Max - $1 billion</div>
                </div>
            </div>


            <div>
            <div class="text-4xl font-medium mb-2 text-center mt-16">Working with us</div>
            <div class="p-2"></div>

            <div class="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-10 mx-auto">

                <div class="shadow-md p-4 max-w-sm ">
                    <div>
                        <img :src="require('@/images/capital.png')" class="mx-auto w-24" />
                    </div>
                    <div class="p-2"></div>
